...
app for `matchmaking function` written in `Java`. It includes an example of how the
...
1. Windows 11 WSL2 or Linux Ubuntu 22.04 or macOS 14+ with the following tools installed:
   ...
   d. JDK 17
      ...
      - On Windows or macOS:
         ...
         Follow the documentation [here](https://learn.microsoft.com/en-us/java/openjdk/install).
